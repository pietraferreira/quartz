...
NOTES: 192 reserved for centrally defined, we are up to around 58. 192 to 255 are set aside for vendor use.
## Approach
...
Here's a code snippet illustrating this concept (`tc_riscv.c`)
