...
# Heapsort
---
Uses [[binary-heap|binary heap trees]] to [[sorting|sort]] (I think!).

It has average [[compiler-optimisation#Performance|performance]]: $O_{n\ log\ n}$
Worst case performance: $O_{n\ log\ n}$

- Refer to [[big-o-notation|big o notation]].
