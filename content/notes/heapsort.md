...
# Heapsort
---
Uses [[notes/general/binary-heap|binary heap trees]] to [[notes/general/sorting|sort]] (I think!).

It has average [[notes/general/compiler-optimisation#Performance|performance]]: $O_{n\ log\ n}$
Worst case performance: $O_{n\ log\ n}$

- Refer to [[notes/general/big-o-notation|big o notation]].
