...
created: 2022-11-07
---
It is an improvement upon [depth-first search](notes/general/depth-first-search.md).
...
If $h$ is always zero (we don't have any information about how far away the goal is), then the algorithm becomes similar to [depth-first search](notes/general/depth-first-search.md).
