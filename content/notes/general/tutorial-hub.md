...
Guides, how-tos and cheatsheets so you can learn along with me :)

## Toolchains & Low-Level
...
- [Generating Shellcode](notes/hacking/generate-shellcode.md)
- [File Transfers Cheatsheet](notes/hacking/htb-file-transfer-cheatsheet.md)
- [MSFConsole Cheatsheet](notes/hacking/htb-msfconsole-cheatsheet.md)
- [Meterpreter Cheatsheet](notes/hacking/htb-meterpreter-cheatsheet.md)
- [Stack-based Buffer Overflows on Linux x86](notes/hacking/htb-stack-based-overflow-linux.md)

## Related
- [Knowledge Hub](notes/general/knowledge-hub.md)
