...
The [[notes/general/compiler-optimisation#Performance|performance]] for bucket for on a given number of digit is $O_{_(n)}$ but also $O_(d)$ in the number of digits.

It is [[notes/general/sorting#Stability|stable]].
